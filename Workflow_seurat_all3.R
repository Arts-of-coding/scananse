...
# converting the data for making a seur_obj_all for convenience sake
seur_obj_all <- lako
...
# Choosing the number of PCAs based on the PCs in 6.Princiole_components.pdf
...
for (i in 1:20){
  ...
  p2 <- ggplot(seur_obj@meta.data, aes(eval(parse(text= cluster_variable_name))))+geom_bar(stat="count")
